...
int main(int argc, char** argv){
  ...
  // dataset
    ...
    const float sim_time = 30.f; // unit: 20ms
    const float sim_step = 1.f; // unit: 20ms
    ...
    SNN->add_layer("Dense", true, false, true, 0.4f, 5.f, 0.15f, 1.f, 1, 0.f, 5, 100);
    SNN->add_layer("Dense", true, false, true, 0.4f, 5.f, 0.15f, 1.f, 1, 0.f, 5, 10);
    SNN->create_network(break_sim);

    /* LEARNING RULE */
    SNN->enable_stdp_paredes(0.001f, 0.f, 0.05f, 10, true, 250, break_sim);
